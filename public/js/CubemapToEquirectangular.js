...
CubemapToEquirectangular.prototype.download = function( imageData ) {
	...
	this.canvas.toBlob( function( blob ) {
		...
		var props = {}, extProps = {}, standardXMP, extendedXMP;
			...
			props['GImage:Mime'] = "image/jpeg";
			// extProps['GImage:Data'] = "image/jpeg";
			// extProps['GPano:ProjectionType'] = "equirectangular";
			// props['GPano:ProjectionType'] = "equirectangular";
			// console.log('Original size', null);

		standardXMP = GDepthEncoder.buildXMP(props);
		extendedXMP = GDepthEncoder.buildXMP(extProps);
